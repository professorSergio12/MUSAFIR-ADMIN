...
const SingleItinerary = ({ onClose }: SingleItineraryProps) => {
  ...
  const handleCancel = () => {
    ...
    if (singleLocationData) {
      ...
      if (typeof formData.locationImage !== 'string' && formData.imagePreview) {
  ...
  const handleSave = async () => {
    ...
    if (typeof formData.locationImage !== 'string') {
  ...
  const handleRemoveImage = () => {
    if (formData.imagePreview && typeof formData.locationImage !== 'string') {
      URL.revokeObjectURL(formData.imagePreview);
    }
    setFormData(prev => ({
      ...prev,
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-xs text-slate-600">
                                    {typeof formData.locationImage !== 'string' ? formData.locationImage.name : 'Existing Image'}
                                  </p>
                                  {typeof formData.locationImage !== 'string' && (
